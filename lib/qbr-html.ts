    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="commentable" data-comment-id="hires-new">
          ...
          <p style="font-size:12px; color:var(--text-secondary); margin-top:8px;">Angelo Licetti and Aayushi Pankaj started early Aug 2026; included here as they are onboard by the time of this QBR.</p>
        </div>
  ...
  <div class="section" id="metrics">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <!-- 3e. Finance &amp; Legal Systems (ETE) — REAL DATA -->
        ...
        <div class="accordion open" id="acc-landings-it">
          ...
          <div class="accordion-content">
            <div class="commentable" data-comment-id="landings-it">
              <p style="font-size:13px; color:var(--text-secondary);">Landings pending — Lalena to provide the IT Foundations list.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="commentable" data-comment-id="roadmap-enttech">
              ...
              <table class="data-table">
                ...
                <tbody>
                  ...
                  <tr><td><strong>Sales Tax &amp; VAT Implementations (CA, CO, Mexico, Singapore, UAE, Malaysia, Kenya)</strong></td><td><span class="pill pill-gray">&mdash;</span></td><td><span class="pill pill-gray">Not Started</span></td><td>eff. 2027</td><td>Finance &amp; Legal</td></tr>
                </tbody>
              </table>
        ...
        <div class="accordion open" id="acc-roadmap-it">
          ...
          <div class="accordion-content">
            <div class="commentable" data-comment-id="roadmap-it">
              <p style="font-size:13px; color:var(--text-secondary);">Roadmap pending — Lalena to provide the IT Foundations look-ahead.</p>
            </div>
          </div>
        </div>

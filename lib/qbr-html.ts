          ...
          <div class="accordion-content">
            <div class="commentable" data-comment-id="landings-it">
              ...
              <table class="data-table">
                <thead><tr><th style="width:26%;">Landing</th><th>What it delivered</th></tr></thead>
                <tbody>
                  <tr><td><strong>AI Skills Library &mdash; live company-wide (skills.wf.app)</strong></td><td>One governed home for every AI skill at Webflow: a private repo holds the skills, a Next.js app on Webflow Cloud serves them at skills.wf.app behind Okta, and people get them three ways &mdash; the web app, a CLI, or their own coding agent. Skills are agent-agnostic (Claude, Codex, Cursor); CI checks every submission for format errors and secrets, a department reviewer approves, then the app publishes to everyone. Built with Utkarsh Sengar and Nisheed Rama. <strong>Impact:</strong> beta live 6/8, company-wide 6/24; 65 skills as of 8/7 (up from ~50 at GA). Skills now move team-to-team without EAI Ops in the loop, each carrying an owner, namespace, and approval record &mdash; the distribution layer for the rest of the AI portfolio (holds org-wide skills that don't belong in the engineering monorepo, and pushes approved skills into Claude Enterprise). Governance is already earning its keep: Nisheed's eval tool flags 26 of 65 skills as failing quality checks &mdash; fixing that is the Q3 job.</td></tr>
